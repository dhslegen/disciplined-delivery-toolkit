...
// 与 hooks/hooks.json 注册的 4 个 hook id 一致；与 bin/ddt-doctor.mjs REQUIRED_HOOKS 一致
const REQUIRED = ['ddt:inject', 'ddt:enforce-pre', 'ddt:metrics-post', 'ddt:metrics-end'];
