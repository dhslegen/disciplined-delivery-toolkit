...
console.log('');
console.log('  [SSoT 真相 — framework-recommended 4 件]');
console.log(`  ${existsSync(path.join(cwd, 'docs/ssot/prd.md')) ? '✓' : '✗'} docs/ssot/prd.md            （需求站产物，PRD）`);
...
console.log(`  ${existsSync(path.join(cwd, 'docs/ssot/openapi')) ? '✓' : '✗'} docs/ssot/openapi/          （契约 SSoT 铁律链）`);
console.log('');
